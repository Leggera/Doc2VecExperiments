...
sizes=('-size 50' '-size 75' '-size 100' '-size 200' '-size 300')
alphas=('-alpha 0.01' '-alpha 0.015' '-alpha 0.02' '-alpha 0.025' '-alpha 0.075' '-alpha 0.1' '-alpha 0.2')
windows=('-window 5' '-window 15' '-window 20' '-window 25')
negatives=('-negative 6' '-negative 12' '-negative 30' '-negative 50')
...
mkdir time_p2v_mc1
time_fold="time_p2v_mc1/"
mkdir space_p2v_mc1
space_fold="space_p2v_mc1/"
